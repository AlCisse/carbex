<x-layouts.app>
    <x-slot name="header">
        <div class="flex items-center justify-between">
            <div>
                <h1 class="text-xl font-semibold text-gray-900">{{ __('carbex.pillars.promote.share') }}</h1>
    ...
    <div class="max-w-4xl mx-auto space-y-8">
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('carbex.promote.marketing_assets') }}</h2>
            </x-slot>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="p-6 border border-gray-200 rounded-xl text-center hover:border-emerald-500 transition-colors">
                    ...
                    <h3 class="font-medium text-gray-900 mb-2">{{ __('carbex.promote.email_signature') }}</h3>
                ...
                <div class="p-6 border border-gray-200 rounded-xl text-center hover:border-emerald-500 transition-colors">
                    ...
                    <h3 class="font-medium text-gray-900 mb-2">{{ __('carbex.promote.embed_widget') }}</h3>
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('carbex.promote.sustainability_journey') }}</h2>
            </x-slot>
