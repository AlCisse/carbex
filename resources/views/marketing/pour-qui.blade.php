...
@section('title', __('linscarbon.marketing.for_who.title') . ' - LinsCarbon')
@section('description', __('linscarbon.marketing.for_who.description'))

@section('content')
<!-- Hero -->
<section class="pt-32 pb-16" style="background: linear-gradient(180deg, #ffffff 0%, #f8fafc 100%);">
    <div class="max-w-4xl mx-auto px-6 text-center">
        <p class="text-sm font-medium mb-4" style="color: var(--accent);">{{ __('linscarbon.marketing.for_who.title') }}</p>
        <h1 class="text-4xl lg:text-5xl font-semibold mb-6" style="color: var(--text-primary); letter-spacing: -0.025em;">
            {{ __('linscarbon.marketing.for_who.hero_title') }}
        </h1>
        <p class="text-lg" style="color: var(--text-secondary);">
            {{ __('linscarbon.marketing.for_who.hero_subtitle') }}
        </p>
    </div>
</section>
...
<section class="py-20" style="background-color: var(--bg-primary);">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-semibold mb-4" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.why_choose.title') }}</h2>
            <p class="text-lg" style="color: var(--text-secondary);">{{ __('linscarbon.marketing.for_who.why_choose.subtitle') }}</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl p-8 border hover-lift" style="border-color: var(--border);">
                ...
                <h3 class="text-xl font-semibold mb-3" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.why_choose.measure_title') }}</h3>
                <p class="text-sm leading-relaxed" style="color: var(--text-secondary);">
                    {{ __('linscarbon.marketing.for_who.why_choose.measure_desc') }}
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 border hover-lift" style="border-color: var(--border);">
                ...
                <h3 class="text-xl font-semibold mb-3" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.why_choose.drive_title') }}</h3>
                <p class="text-sm leading-relaxed" style="color: var(--text-secondary);">
                    {{ __('linscarbon.marketing.for_who.why_choose.drive_desc') }}
                </p>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 border hover-lift" style="border-color: var(--border);">
                ...
                <h3 class="text-xl font-semibold mb-3" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.why_choose.comply_title') }}</h3>
                <p class="text-sm leading-relaxed" style="color: var(--text-secondary);">
                    {{ __('linscarbon.marketing.for_who.why_choose.comply_desc') }}
                </p>
            </div>
        </div>
    </div>
...
<section class="py-20" style="background-color: var(--bg-card);">
    <div class="max-w-6xl mx-auto px-6">
        <div class="text-center mb-16">
            <h2 class="text-3xl font-semibold mb-4" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.audiences.title') }}</h2>
            <p class="text-lg" style="color: var(--text-secondary);">{{ __('linscarbon.marketing.for_who.audiences.subtitle') }}</p>
        </div>
        ...
        <div class="grid md:grid-cols-3 gap-8">
            ...
            <div class="bg-white rounded-2xl overflow-hidden border hover-lift" style="border-color: var(--border);">
                <div class="p-6" style="background: linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 100%);">
                    ...
                    <h3 class="text-2xl font-semibold" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.audiences.sme.title') }}</h3>
                    <p class="text-sm" style="color: var(--text-secondary);">{{ __('linscarbon.marketing.for_who.audiences.sme.size') }}</p>
                </div>
                <div class="p-6">
                    <p class="text-sm mb-6" style="color: var(--text-secondary);">
                        {{ __('linscarbon.marketing.for_who.audiences.sme.desc') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            ...
                            {{ __('linscarbon.marketing.for_who.audiences.sme.feature1') }}
                        </li>
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            {{ __('linscarbon.marketing.for_who.audiences.sme.feature2') }}
                        </li>
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            {{ __('linscarbon.marketing.for_who.audiences.sme.feature3') }}
                        </li>
                    </ul>
                    <a href="{{ route('register') }}" class="btn-primary mt-6 block w-full py-3 text-center text-sm font-medium text-white rounded-xl" style="background-color: var(--accent);">
                        {{ __('linscarbon.marketing.for_who.audiences.sme.cta') }}
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden border hover-lift" style="border-color: var(--border);">
                <div class="p-6" style="background: linear-gradient(135deg, #dbeafe 0%, #bfdbfe 100%);">
                    ...
                    <h3 class="text-2xl font-semibold" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.audiences.midsize.title') }}</h3>
                    <p class="text-sm" style="color: var(--text-secondary);">{{ __('linscarbon.marketing.for_who.audiences.midsize.size') }}</p>
                </div>
                <div class="p-6">
                    <p class="text-sm mb-6" style="color: var(--text-secondary);">
                        {{ __('linscarbon.marketing.for_who.audiences.midsize.desc') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {{ __('linscarbon.marketing.for_who.audiences.midsize.feature1') }}
                        </li>
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            {{ __('linscarbon.marketing.for_who.audiences.midsize.feature2') }}
                        </li>
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            {{ __('linscarbon.marketing.for_who.audiences.midsize.feature3') }}
                        </li>
                    </ul>
                    <a href="{{ route('register') }}?plan=premium" class="btn-primary mt-6 block w-full py-3 text-center text-sm font-medium text-white rounded-xl" style="background-color: var(--accent);">
                        {{ __('linscarbon.marketing.for_who.audiences.midsize.cta') }}
                    </a>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl overflow-hidden border hover-lift" style="border-color: var(--border);">
                <div class="p-6" style="background: linear-gradient(135deg, #f3e8ff 0%, #e9d5ff 100%);">
                    ...
                    <h3 class="text-2xl font-semibold" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.audiences.enterprise.title') }}</h3>
                    <p class="text-sm" style="color: var(--text-secondary);">{{ __('linscarbon.marketing.for_who.audiences.enterprise.size') }}</p>
                </div>
                <div class="p-6">
                    <p class="text-sm mb-6" style="color: var(--text-secondary);">
                        {{ __('linscarbon.marketing.for_who.audiences.enterprise.desc') }}
                    </p>
                    <ul class="space-y-3">
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                            ...
                            {{ __('linscarbon.marketing.for_who.audiences.enterprise.feature1') }}
                        </li>
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            {{ __('linscarbon.marketing.for_who.audiences.enterprise.feature2') }}
                        </li>
                        <li class="flex items-start gap-2.5 text-sm" style="color: var(--text-secondary);">
                            <svg class="w-5 h-5 flex-shrink-0 mt-0.5" style="color: var(--accent);" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M5 13l4 4L19 7" />
                            </svg>
                            {{ __('linscarbon.marketing.for_who.audiences.enterprise.feature3') }}
                        </li>
                    </ul>
                    <a href="/contact" class="mt-6 block w-full py-3 text-center text-sm font-medium rounded-xl border" style="color: var(--text-primary); border-color: var(--border);">
                        {{ __('linscarbon.marketing.for_who.audiences.enterprise.cta') }}
                    </a>
                </div>
            </div>
        </div>
...
<section class="py-16" style="background-color: var(--bg-primary);">
    <div class="max-w-6xl mx-auto px-6">
        <p class="text-center text-sm font-medium mb-10" style="color: var(--text-muted);">{{ __('linscarbon.marketing.for_who.trust_us') }}</p>
...
<section class="py-20" style="background-color: var(--bg-card);">
    <div class="max-w-4xl mx-auto px-6">
        <div class="text-center mb-12">
            <h2 class="text-2xl font-semibold mb-4" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.testimonial.title') }}</h2>
        </div>
        ...
        <div class="bg-white rounded-2xl p-8 md:p-12 border relative" style="border-color: var(--border);">
            ...
            <div class="relative">
                <p class="text-lg md:text-xl leading-relaxed mb-8" style="color: var(--text-secondary);">
                    "{{ __('linscarbon.marketing.for_who.testimonial.quote') }}"
                </p>
                <div class="flex items-center gap-4">
                    ...
                    <div>
                        <p class="font-semibold" style="color: var(--text-primary);">{{ __('linscarbon.marketing.for_who.testimonial.author') }}</p>
                        <p class="text-sm" style="color: var(--text-muted);">{{ __('linscarbon.marketing.for_who.testimonial.role') }}</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="py-20" style="background: linear-gradient(135deg, #f0fdfa 0%, #ccfbf1 100%);">
    <div class="max-w-3xl mx-auto px-6 text-center">
        <h2 class="text-3xl font-semibold mb-5" style="color: var(--text-primary);">
            {{ __('linscarbon.marketing.for_who.cta.title') }}
        </h2>
        <p class="text-lg mb-10" style="color: var(--text-secondary);">
            {{ __('linscarbon.marketing.for_who.cta.subtitle') }}
        </p>
        <div class="flex flex-col sm:flex-row items-center justify-center gap-4">
            <a href="{{ route('register') }}" class="btn-primary inline-flex items-center px-6 py-3.5 text-sm font-medium text-white rounded-xl" style="background-color: var(--accent);">
                {{ __('linscarbon.marketing.for_who.cta.primary') }}
            ...
            <a href="{{ route('pricing') }}" class="inline-flex items-center px-6 py-3.5 text-sm font-medium rounded-xl border-2" style="color: var(--accent); border-color: var(--accent);">
                {{ __('linscarbon.marketing.for_who.cta.secondary') }}
            </a>
        </div>
    </div>
</section>
