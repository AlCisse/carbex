...
@section('title', 'Contact - Carbex')
@section('description', 'Contactez l\'equipe Carbex pour toute question sur notre plateforme de bilan carbone.')

@section('content')
<section class="pt-32 pb-20" style="background: linear-gradient(180deg, #ffffff 0%, #f8fafc 100%);">
    <div class="max-w-4xl mx-auto px-6">
        <div class="text-center mb-12">
            <p class="text-sm font-medium mb-4" style="color: var(--accent);">Contact</p>
            <h1 class="text-4xl font-semibold mb-6" style="color: var(--text-primary); letter-spacing: -0.025em;">
                Parlons de votre projet
            </h1>
            <p class="text-lg" style="color: var(--text-secondary);">
                Notre equipe est la pour repondre a vos questions et vous accompagner.
            </p>
        </div>
        ...
        <div class="grid md:grid-cols-2 gap-12">
            <!-- Contact Info -->
            <div>
                <h2 class="text-xl font-semibold mb-6" style="color: var(--text-primary);">Nous contacter</h2>
                ...
                <div class="space-y-6">
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-medium" style="color: var(--text-primary);">Telephone</p>
                    ...
                    <div class="flex items-start gap-4">
                        ...
                        <div>
                            <p class="font-medium" style="color: var(--text-primary);">Adresse</p>
                ...
                <div class="mt-10 p-6 rounded-xl" style="background-color: #f0fdfa;">
                    <h3 class="font-medium mb-2" style="color: var(--text-primary);">Horaires</h3>
                    <p class="text-sm" style="color: var(--text-secondary);">
                        Lundi - Vendredi : 9h00 - 18h00<br>
                        Support clients Premium : 24/7
                    </p>
                </div>
            </div>
            ...
            <div class="bg-white rounded-2xl p-8 border" style="border-color: var(--border);">
                <h2 class="text-xl font-semibold mb-6" style="color: var(--text-primary);">Envoyer un message</h2>

                <form action="#" method="POST" class="space-y-5">
                    @csrf
                    <div>
                        <label for="name" class="block text-sm font-medium mb-1.5" style="color: var(--text-primary);">Nom complet</label>
                    ...
                    <div>
                        <label for="email" class="block text-sm font-medium mb-1.5" style="color: var(--text-primary);">Email professionnel</label>
                    ...
                    <div>
                        <label for="company" class="block text-sm font-medium mb-1.5" style="color: var(--text-primary);">Entreprise</label>
                    ...
                    <div>
                        <label for="subject" class="block text-sm font-medium mb-1.5" style="color: var(--text-primary);">Sujet</label>
                    ...
                    <div>
                        <label for="message" class="block text-sm font-medium mb-1.5" style="color: var(--text-primary);">Message</label>
