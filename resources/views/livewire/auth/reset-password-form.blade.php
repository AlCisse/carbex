<div>
    <x-slot name="heading">
        {{ __('carbex.auth.reset_password_title') }}
    </x-slot>

    <x-slot name="subheading">
        {{ __('carbex.auth.reset_password_subtitle') }}
    </x-slot>
    ...
    <form wire:submit="resetPassword" class="space-y-6">
        ...
        <div>
            <button type="submit"
                ...
                <span wire:loading.remove>{{ __('carbex.auth.reset_password_button') }}</span>
