<div>
    <x-slot name="heading">
        {{ __('linscarbon.auth.login_title') }}
    </x-slot>

    <x-slot name="subheading">
        {{ __('linscarbon.auth.login_subtitle') }}
    </x-slot>
    ...
    <form wire:submit="login" class="space-y-6">
            ...
            <div class="flex items-center justify-between">
                ...
                <div class="text-sm">
                    <a href="{{ route('password.request') }}" class="font-semibold text-green-600 hover:text-green-500">
                        {{ __('linscarbon.auth.forgot_password') }}
                    </a>
                </div>
            </div>
            <div class="mt-2">
        ...
        <div class="flex items-center">
            ...
            <label for="remember" class="ml-3 block text-sm leading-6 text-gray-900">
                {{ __('linscarbon.auth.remember_me') }}
            </label>
        </div>
        ...
        <div>
            <button type="submit"
                ...
                <span wire:loading.remove>{{ __('linscarbon.auth.login_button') }}</span>
