<div class="space-y-6">
    ...
    <div class="border-b border-gray-200 dark:border-gray-700 pb-4">
        <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
            {{ __('carbex.gdpr.title') }}
        </h2>
        <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
            {{ __('carbex.gdpr.subtitle') }}
        </p>
    </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        <h3 class="text-lg font-medium text-gray-900 dark:text-white mb-4">
            {{ __('carbex.gdpr.consent_title') }}
        </h3>
        <p class="text-sm text-gray-600 dark:text-gray-400 mb-6">
            {{ __('carbex.gdpr.consent_description') }}
        </p>
        ...
        <div class="space-y-4">
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div>
                    <h4 class="font-medium text-gray-900 dark:text-white">
                        {{ __('carbex.gdpr.consent_marketing') }}
                    </h4>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ __('carbex.gdpr.legal_basis_consent') }}
                    </p>
                </div>
            ...
            <div class="flex items-center justify-between p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                <div>
                    <h4 class="font-medium text-gray-900 dark:text-white">
                        {{ __('carbex.gdpr.consent_analytics') }}
                    </h4>
                    <p class="text-sm text-gray-500 dark:text-gray-400">
                        {{ __('carbex.gdpr.legal_basis_legitimate') }}
                    </p>
                </div>
                <label class="relative inline-flex items-center cursor-pointer">
                    <input
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-medium text-gray-900 dark:text-white">
                    {{ __('carbex.gdpr.export_data') }}
                </h3>
                <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">
                    {{ __('carbex.gdpr.export_description') }}
                </p>
                    ...
                    @else
                        ...
                        >
                            ...
                            <span wire:loading wire:target="exportData">
                                ...
                                {{ __('carbex.gdpr.export_processing') }}
                            </span>
                        </button>
                    @endif
                </div>
    ...
    <div class="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-6">
        ...
        <div class="grid gap-4 sm:grid-cols-2">
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('carbex.gdpr.access_description') }}
                </p>
            </div>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('carbex.gdpr.rectification_description') }}
                </p>
            </div>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('carbex.gdpr.portability_description') }}
                </p>
            </div>
            ...
            <div class="p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg">
                ...
                <p class="text-xs text-gray-500 dark:text-gray-400 mt-1">
                    {{ __('carbex.gdpr.object_description') }}
                </p>
            </div>
        </div>
        ...
        <div class="mt-6 p-4 bg-blue-50 dark:bg-blue-900/20 rounded-lg">
            <p class="text-sm text-blue-800 dark:text-blue-200">
                <strong>{{ __('carbex.gdpr.dpo_contact') }}:</strong>
                <a href="mailto:{{ __('carbex.gdpr.dpo_email') }}" class="underline hover:no-underline">
                    {{ __('carbex.gdpr.dpo_email') }}
                </a>
            </p>
        </div>
    </div>
        ...
        <div class="flex items-start gap-4">
            ...
            <div class="flex-1">
                <h3 class="text-lg font-medium text-red-800 dark:text-red-200">
                    {{ __('carbex.gdpr.delete_account') }}
                </h3>
                <p class="mt-1 text-sm text-red-700 dark:text-red-300">
                    {{ __('carbex.gdpr.delete_description') }}
                </p>
                <p class="mt-2 text-xs text-red-600 dark:text-red-400">
                    {{ __('carbex.gdpr.delete_warning') }}
                </p>
                    ...
                    <div class="sm:flex sm:items-start">
                        ...
                        <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                            <h3 class="text-lg leading-6 font-medium text-gray-900 dark:text-white" id="modal-title">
                                {{ __('carbex.gdpr.delete_confirm_title') }}
                            </h3>
                            <div class="mt-2">
                                <p class="text-sm text-gray-500 dark:text-gray-400">
                                    {{ __('carbex.gdpr.delete_confirm_message') }}
                                </p>
                                <input
                                    type="text"
                                    ...
                                    placeholder="{{ __('carbex.gdpr.delete_confirm_word') }}"
                                >
