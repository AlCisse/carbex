<div>
    <x-slot name="header">
        <h1 class="text-xl font-semibold text-gray-900">{{ __('linscarbon.settings.organization') }}</h1>
    </x-slot>
    ...
    <form wire:submit="save" class="space-y-8">
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('linscarbon.organization.general_info') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('linscarbon.organization.general_info_desc') }}</p>
            </x-slot>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div class="sm:col-span-2">
                    <x-input
                        wire:model="name"
                        name="name"
                        :label="__('linscarbon.organization.name')"
                        required
                ...
                <div>
                    <x-input
                        ...
                        name="legal_name"
                        :label="__('linscarbon.organization.legal_name')"
                ...
                <div>
                    <x-select
                        wire:model="sector"
                        name="sector"
                        :label="__('linscarbon.organization.sector')"
                        :placeholder="__('linscarbon.common.select')"
                    >
                ...
                <div>
                    <x-select
                        wire:model="size"
                        name="size"
                        :label="__('linscarbon.organization.size')"
                        :placeholder="__('linscarbon.common.select')"
                    >
                ...
                <div>
                    <x-input
                        ...
                        name="website"
                        type="url"
                        :label="__('linscarbon.organization.website')"
                        placeholder="https://"
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('linscarbon.organization.legal_info') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('linscarbon.organization.legal_info_desc') }}</p>
            </x-slot>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    <x-input
                        ...
                        name="vat_number"
                        :label="__('linscarbon.organization.vat_number')"
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('linscarbon.organization.contact_info') }}</h2>
            </x-slot>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    <x-input
                        ...
                        name="email"
                        type="email"
                        :label="__('linscarbon.auth.email')"
                ...
                <div>
                    <x-input
                        ...
                        name="phone"
                        type="tel"
                        :label="__('linscarbon.organization.phone')"
                ...
                <div class="sm:col-span-2">
                    <x-input
                        ...
                        name="address_line_1"
                        :label="__('linscarbon.organization.address')"
                ...
                <div class="sm:col-span-2">
                    <x-input
                        ...
                        name="address_line_2"
                        :label="__('linscarbon.organization.address_line_2')"
                ...
                <div>
                    <x-input
                        ...
                        name="postal_code"
                        :label="__('linscarbon.organization.postal_code')"
                ...
                <div>
                    <x-input
                        wire:model="city"
                        name="city"
                        :label="__('linscarbon.organization.city')"
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('linscarbon.organization.fiscal_settings') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('linscarbon.organization.fiscal_settings_desc') }}</p>
            </x-slot>
            ...
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                <div>
                    <x-select
                        ...
                        :label="__('linscarbon.organization.fiscal_year_start')"
                    >
                        @for ($i = 1; $i <= 12; $i++)
                ...
                <div>
                    <x-select
                        ...
                        :label="__('linscarbon.organization.default_currency')"
                    >
                        <option value="EUR">{{ __('linscarbon.organization.currencies.eur') }}</option>
                        <option value="CHF">{{ __('linscarbon.organization.currencies.chf') }}</option>
                        <option value="GBP">{{ __('linscarbon.organization.currencies.gbp') }}</option>
                    </x-select>
                </div>
            </div>
        </x-card>
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('linscarbon.organization.display_settings') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('linscarbon.organization.display_settings_desc') }}</p>
            </x-slot>
            ...
            <div class="space-y-6">
                ...
                <div>
                    <label class="block text-sm font-medium text-gray-700 mb-3">
                        {{ __('linscarbon.organization.navigation_mode') }}
                    </label>
                            ...
                            <span class="flex flex-1">
                                <span class="flex flex-col">
                                    <span class="flex items-center">
                                        ...
                                        <span class="block text-sm font-medium text-gray-900">{{ __('linscarbon.navigation.mode.scopes') }}</span>
                                    </span>
                                    <span class="mt-1 flex items-center text-sm text-gray-500">
                                        {{ __('linscarbon.organization.navigation_scopes_desc') }}
                                    </span>
                                </span>
                            </span>
                            ...
                            <span class="flex flex-1">
                                <span class="flex flex-col">
                                    <span class="flex items-center">
                                        ...
                                        <span class="block text-sm font-medium text-gray-900">{{ __('linscarbon.navigation.mode.pillars') }}</span>
                                        <span class="ml-2 inline-flex items-center px-2 py-0.5 rounded text-xs font-medium bg-purple-100 text-purple-800">NEW</span>
                                    </span>
                                    <span class="mt-1 flex items-center text-sm text-gray-500">
                                        {{ __('linscarbon.organization.navigation_pillars_desc') }}
                                    </span>
                                </span>
                            </span>
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('linscarbon.organization.country_config') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('linscarbon.organization.country_config_desc') }}</p>
            </x-slot>

            <div class="grid grid-cols-1 gap-4 sm:grid-cols-3">
                <div class="rounded-lg bg-gray-50 p-4">
                    <dt class="text-sm font-medium text-gray-500">{{ __('linscarbon.organization.country') }}</dt>
                    <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $countryConfig['name'] ?? $organization->country }}</dd>
                </div>
                <div class="rounded-lg bg-gray-50 p-4">
                    <dt class="text-sm font-medium text-gray-500">{{ __('linscarbon.organization.timezone') }}</dt>
                    <dd class="mt-1 text-lg font-semibold text-gray-900">{{ $organization->timezone }}</dd>
                </div>
                <div class="rounded-lg bg-gray-50 p-4">
                    <dt class="text-sm font-medium text-gray-500">{{ __('linscarbon.organization.vat_rate') }}</dt>
        ...
        <div class="flex justify-end">
            <x-button type="submit" wire:loading.attr="disabled">
                <span wire:loading.remove>{{ __('linscarbon.common.save') }}</span>
                <span wire:loading>{{ __('linscarbon.common.saving') }}</span>
            </x-button>
        </div>
    </form>
</div>
