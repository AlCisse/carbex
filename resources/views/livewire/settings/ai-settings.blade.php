    ...
    <div class="space-y-8">
        ...
        <x-card>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                ...
                <div class="bg-gray-50 rounded-lg p-4">
                    <div class="flex items-center justify-between mb-2">
                        <span class="text-sm font-medium text-gray-600">{{ __('carbex.settings.ai.remaining_requests') }}</span>
                        <svg class="w-5 h-5 text-gray-400" fill="none" viewBox="0 0 24 24" stroke="currentColor">
                    ...
                    <p class="mt-2 text-xs text-gray-500">{{ __('carbex.settings.ai.requests_available') }}</p>
                </div>
            </div>
        </x-card>
        ...
        <x-card>
            <x-slot name="header">
                <h2 class="text-lg font-medium text-gray-900">{{ __('carbex.settings.ai.your_model') }}</h2>
                <p class="mt-1 text-sm text-gray-500">{{ __('carbex.settings.ai.your_model_desc') }}</p>
            </x-slot>
            ...
            <div class="flex items-center justify-between p-4 rounded-lg border border-blue-200 bg-blue-50">
                <div class="flex items-center">
                    ...
                    <div>
                        ...
                        <p class="text-sm text-gray-600">{{ __('carbex.settings.ai.model_for_plan', ['plan' => $subscriptionLimits['plan_label'] ?? 'Free']) }}</p>
                    </div>
                </div>
