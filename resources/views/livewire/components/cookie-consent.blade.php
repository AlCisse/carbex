    ...
    <div class="max-w-4xl mx-auto bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 overflow-hidden">
        ...
        <div class="p-6">
            <div class="flex items-start gap-4">
                ...
                <div class="flex-1">
                    <h3 class="text-lg font-semibold text-gray-900 dark:text-white">
                        {{ __('carbex.cookies.title') }}
                    </h3>
                    <p class="mt-1 text-sm text-gray-600 dark:text-gray-300">
                        {{ __('carbex.cookies.description') }}
                    </p>
                    <p class="mt-2 text-xs text-gray-500 dark:text-gray-400">
                        {{ __('carbex.cookies.legal_notice') }}
                    </p>
                </div>
            </div>
            ...
            <div class="mt-6 flex flex-wrap gap-3">
                ...
                >
                    {{ __('carbex.cookies.essential_only') }}
                </button>
        ...
        >
            <div class="p-6 space-y-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <h4 class="font-medium text-gray-900 dark:text-white">
                            {{ __('carbex.cookies.essential_title') }}
                        </h4>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ __('carbex.cookies.essential_desc') }}
                        </p>
                    </div>
                    <div class="flex-shrink-0 ml-4">
                        <span class="px-3 py-1 text-xs font-medium bg-green-100 text-green-800 dark:bg-green-900/30 dark:text-green-400 rounded-full">
                            {{ __('carbex.cookies.always_active') }}
                        </span>
                    </div>
                </div>
                ...
                <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <h4 class="font-medium text-gray-900 dark:text-white">
                            {{ __('carbex.cookies.functional_title') }}
                        </h4>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ __('carbex.cookies.functional_desc') }}
                        </p>
                    </div>
                    <div class="flex-shrink-0 ml-4">
                ...
                <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <h4 class="font-medium text-gray-900 dark:text-white">
                            {{ __('carbex.cookies.analytics_title') }}
                        </h4>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ __('carbex.cookies.analytics_desc') }}
                        </p>
                    </div>
                    <div class="flex-shrink-0 ml-4">
                        <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="flex items-center justify-between p-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700">
                    <div class="flex-1">
                        <h4 class="font-medium text-gray-900 dark:text-white">
                            {{ __('carbex.cookies.marketing_title') }}
                        </h4>
                        <p class="text-sm text-gray-500 dark:text-gray-400">
                            {{ __('carbex.cookies.marketing_desc') }}
                        </p>
                    </div>
                    <div class="flex-shrink-0 ml-4">
                        <label class="relative inline-flex items-center cursor-pointer">
                ...
                <div class="flex justify-end pt-4">
                    <button
                        ...
                        class="px-5 py-2.5 bg-green-600 hover:bg-green-700 text-white text-sm font-medium rounded-lg transition-colors"
                    >
                        {{ __('carbex.cookies.save_preferences') }}
                    </button>
                </div>
