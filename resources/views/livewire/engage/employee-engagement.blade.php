<div class="space-y-6">
    ...
    <div class="flex flex-col md:flex-row md:items-center md:justify-between">
        <div>
            <h1 class="text-2xl font-bold text-gray-900 dark:text-white">
                {{ __('linscarbon.engage.title') }}
            </h1>
            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">
                {{ __('linscarbon.engage.description') }}
            </p>
        </div>
        <div class="mt-4 md:mt-0 flex items-center space-x-2 bg-emerald-50 dark:bg-emerald-900/20 px-4 py-2 rounded-lg">
            ...
            <span class="font-semibold text-emerald-700 dark:text-emerald-300">
                {{ __('linscarbon.engage.your_points') }}: {{ $userPoints }}
            </span>
        </div>
    </div>
    ...
    <nav class="flex space-x-1 overflow-x-auto" aria-label="Tabs">
        @php
            $tabs = [
                'quiz' => __('linscarbon.engage.tabs.quiz'),
                'calculator' => __('linscarbon.engage.tabs.calculator'),
                'challenges' => __('linscarbon.engage.tabs.challenges'),
                'leaderboard' => __('linscarbon.engage.tabs.leaderboard'),
            ];
        @endphp
    ...
    <div class="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 p-6">
            ...
            @else
                ...
                <div class="text-center space-y-6">
                    ...
                    <h2 class="text-xl font-semibold text-gray-900 dark:text-white">
                        {{ __('linscarbon.engage.quiz.completed') }}
                    </h2>

                    <p class="text-gray-600 dark:text-gray-400">
                        {{ $quizScore >= 80 ? __('linscarbon.engage.quiz.excellent') : ($quizScore >= 60 ? __('linscarbon.engage.quiz.good') : __('linscarbon.engage.quiz.keep_learning')) }}
                    </p>
                    ...
                    >
                        {{ __('linscarbon.engage.quiz.retry') }}
                    </button>
                </div>
            @endif
        ...
        @elseif($activeTab === 'calculator')
            ...
            <div class="space-y-6">
                ...
                @if(!$calculatorResult)
                    <div class="grid md:grid-cols-2 gap-6">
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('linscarbon.engage.calculator.commute_distance') }}
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('linscarbon.engage.calculator.commute_mode') }}
                            </label>
                            <select
                                wire:model="calculatorInputs.commute_mode"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                            >
                                <option value="car_petrol">{{ __('linscarbon.engage.calculator.modes.car_petrol') }}</option>
                                <option value="car_diesel">{{ __('linscarbon.engage.calculator.modes.car_diesel') }}</option>
                                <option value="car_electric">{{ __('linscarbon.engage.calculator.modes.car_electric') }}</option>
                                <option value="public_transport">{{ __('linscarbon.engage.calculator.modes.public_transport') }}</option>
                                <option value="bike">{{ __('linscarbon.engage.calculator.modes.bike') }}</option>
                                <option value="walk">{{ __('linscarbon.engage.calculator.modes.walk') }}</option>
                            </select>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('linscarbon.engage.calculator.diet') }}
                            </label>
                            <select
                                wire:model="calculatorInputs.diet"
                                class="w-full px-3 py-2 border border-gray-300 dark:border-gray-600 rounded-lg bg-white dark:bg-gray-700 text-gray-900 dark:text-white"
                            >
                                <option value="vegan">{{ __('linscarbon.engage.calculator.diets.vegan') }}</option>
                                <option value="vegetarian">{{ __('linscarbon.engage.calculator.diets.vegetarian') }}</option>
                                <option value="mixed">{{ __('linscarbon.engage.calculator.diets.mixed') }}</option>
                                <option value="meat_heavy">{{ __('linscarbon.engage.calculator.diets.meat_heavy') }}</option>
                            </select>
                        </div>
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('linscarbon.engage.calculator.flights_short') }}
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            <label class="block text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                                {{ __('linscarbon.engage.calculator.flights_long') }}
                            </label>
                            <input
                                type="number"
                        ...
                        <div>
                            ...
                            >
                                ...
                                <option value="oil">{{ __('linscarbon.engage.calculator.heating.oil') }}</option>
                                <option value="electric">{{ __('linscarbon.engage.calculator.heating.electric') }}</option>
                                <option value="heat_pump">{{ __('linscarbon.engage.calculator.heating.heat_pump') }}</option>
                            </select>
                        </div>
                    </div>
                    ...
                    >
                        {{ __('linscarbon.engage.calculator.calculate') }}
                    </button>
                @else
                    <!-- Results -->
                    <div class="space-y-6">
        ...
        @elseif($activeTab === 'challenges')
            ...
            <div class="space-y-6">
                <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                    {{ __('linscarbon.engage.challenges.title') }}
                </h2>
                        ...
                        <div class="border border-gray-200 dark:border-gray-600 rounded-lg p-4 space-y-3">
                            <div class="flex justify-between items-start">
                                <h3 class="font-medium text-gray-900 dark:text-white">
                                    {{ __('linscarbon.engage.challenges.' . $key) }}
                                </h3>
                            ...
                            @if(isset($activeChallenges[$key]))
                                <div class="flex space-x-2">
                                    ...
                                    >
                                        {{ __('linscarbon.engage.challenges.mark_complete') }}
                                    </button>
                                    <button
                                    ...
                                    >
                                        {{ __('linscarbon.engage.challenges.leave') }}
                                    </button>
                                </div>
                            @else
                                <button
                                ...
                                >
                                    {{ __('linscarbon.engage.challenges.join') }}
                                </button>
                            @endif
                        </div>
                    @endforeach
        ...
        @elseif($activeTab === 'leaderboard')
            ...
            <div class="space-y-6">
                <div class="flex justify-between items-center">
                    <h2 class="text-lg font-semibold text-gray-900 dark:text-white">
                        {{ __('linscarbon.engage.leaderboard.title') }}
                    </h2>
                    ...
                    >
                        {{ __('linscarbon.engage.leaderboard.participate') }}
                ...
                @if($participateInLeaderboard)
                    <div class="bg-emerald-50 dark:bg-emerald-900/20 rounded-lg p-4 text-center">
                        <p class="text-sm text-gray-600 dark:text-gray-400">
                            {{ __('linscarbon.engage.leaderboard.your_rank') }}
                        </p>
                    ...
                    <table class="min-w-full">
                        <thead>
                            <tr class="border-b border-gray-200 dark:border-gray-700">
                                <th class="py-2 text-left text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('linscarbon.engage.leaderboard.rank') }}</th>
                                <th class="py-2 text-left text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('linscarbon.engage.leaderboard.name') }}</th>
                                <th class="py-2 text-right text-sm font-medium text-gray-500 dark:text-gray-400">{{ __('linscarbon.engage.leaderboard.points') }}</th>
                            </tr>
                        </thead>
