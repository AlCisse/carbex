<div class="bg-white rounded-lg shadow-sm border border-gray-200 p-6" dusk="carbon-equivalents">
    <h3 class="text-lg font-semibold text-gray-900 mb-2">{{ __('linscarbon.dashboard.equivalents_title') }}</h3>
    <p class="text-sm text-gray-500 mb-6">{{ __('linscarbon.dashboard.equivalents_subtitle') }}</p>
        ...
        <div class="mt-4 pt-4 border-t border-gray-200 text-center">
            <p class="text-sm text-gray-500">
                ...
                <span class="font-semibold text-gray-900">
                    @if($totalKg >= 1000)
                        {{ number_format($totalKg / 1000, 2, ',', ' ') }} {{ __('linscarbon.units.tonnes') }}
                    @else
    ...
    @else
        ...
        <div class="text-center py-8">
            ...
            <p class="text-gray-500">{{ __('linscarbon.dashboard.no_emissions') }}</p>
        </div>
    @endif
</div>
