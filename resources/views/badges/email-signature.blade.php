                    ...
                    <tr>
                        ...
                        <td style="vertical-align: middle;">
                            <p style="margin: 0 0 2px 0; font-size: 13px; font-weight: 600; color: #065f46;">
                                🏆 {{ $badge['name'] ?? __('linscarbon.promote.carbon_badge') }}
                            </p>
                            <p style="margin: 0 0 4px 0; font-size: 11px; color: #047857;">
                                {{ $organization->name ?? __('linscarbon.promote.our_organization') }}
                            </p>
                            <table cellpadding="0" cellspacing="0" border="0" style="border-collapse: collapse;">
                                <tr>
                                    <td>
        ...
        <tr>
            <td style="padding-top: 8px; text-align: left;">
                <a href="{{ url('/') }}" target="_blank" style="display: inline-flex; align-items: center; text-decoration: none;">
                    ...
                    <span style="font-size: 11px; color: #6b7280;">{{ __('linscarbon.promote.powered_by') }} </span>
                    <span style="font-size: 11px; color: #10b981; font-weight: 600; margin-left: 2px;">LinsCarbon</span>
                </a>
            </td>
        </tr>
    </table>
