...
>
    ...
    <nav class="flex-1 overflow-y-auto py-4">
        ...
        <a href="{{ route('emissions') }}"
           class="flex items-center px-4 py-2.5 text-sm font-medium {{ request()->routeIs('emissions') ? 'bg-slate-700 text-white' : 'text-slate-300 hover:bg-slate-700 hover:text-white' }}">
            <svg class="mr-3 h-5 w-5" fill="none" viewBox="0 0 24 24" stroke="currentColor">
