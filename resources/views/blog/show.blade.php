...
@section('title', ($post->meta_title ?? $post->title) . ' - Blog LinsCarbon')
    ...
    <header class="max-w-3xl mx-auto px-6 mb-12">
        <div class="mb-8">
            <a href="{{ route('blog.index') }}" class="inline-flex items-center gap-2 text-sm transition-colors hover:opacity-80" style="color: var(--accent);">
                ...
                {{ __('linscarbon.blog.back_to_blog') }}
            </a>
        </div>
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-sm" style="color: var(--text-muted);">{{ $post->reading_time }} {{ __('linscarbon.blog.min_read') }}</span>
        </div>
        ...
        <div class="flex items-center gap-4 mt-8 pt-8 border-t" style="border-color: var(--border);">
            ...
            <div>
                <p class="font-medium" style="color: var(--text-primary);">{{ $post->author->name ?? 'LinsCarbon' }}</p>
                <p class="text-sm" style="color: var(--text-muted);">{{ $post->author->email ?? 'contact@linscarbon.fr' }}</p>
            </div>
        </div>
    </header>
...
<section class="py-20" style="background-color: #f8fafc;">
    <div class="max-w-6xl mx-auto px-6">
        <h2 class="text-2xl font-semibold mb-8" style="color: var(--text-primary);">{{ __('linscarbon.blog.related_articles') }}</h2>
...
<section class="py-20" style="background-color: var(--accent);">
    <div class="max-w-3xl mx-auto px-6 text-center">
        <h2 class="text-2xl font-semibold text-white mb-4">
            {{ __('linscarbon.blog.cta_title') }}
        </h2>
        <p class="text-white/80 mb-8">
            {{ __('linscarbon.blog.cta_subtitle') }}
        </p>
