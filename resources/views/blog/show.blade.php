...
<article class="pt-32 pb-20">
    ...
    <header class="max-w-3xl mx-auto px-6 mb-12">
        ...
        <div class="flex items-center gap-3 mb-6">
            ...
            <span class="text-sm" style="color: var(--text-muted);">{{ $post->reading_time }} {{ __('carbex.blog.min_read') }}</span>
        </div>
...
<section class="py-20" style="background-color: #f8fafc;">
    <div class="max-w-6xl mx-auto px-6">
        <h2 class="text-2xl font-semibold mb-8" style="color: var(--text-primary);">{{ __('carbex.blog.related_articles') }}</h2>
...
<section class="py-20" style="background-color: var(--accent);">
    <div class="max-w-3xl mx-auto px-6 text-center">
        <h2 class="text-2xl font-semibold text-white mb-4">
            {{ __('carbex.blog.cta_title') }}
        </h2>
        <p class="text-white/80 mb-8">
            {{ __('carbex.blog.cta_subtitle') }}
        </p>
