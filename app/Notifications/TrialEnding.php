...
class TrialEnding extends Notification implements ShouldQueue
{
    ...
    public function toMail(object $notifiable): MailMessage
    {
        ...
        return (new MailMessage)
            ->subject(__('Your LinsCarbon Trial Ends in :days Days', ['days' => $daysRemaining]))
    ...
    public function toArray(object $notifiable): array
    {
        return [
            ...
            'message' => __('Your free trial ends in :days days. Upgrade to continue using LinsCarbon.', [
