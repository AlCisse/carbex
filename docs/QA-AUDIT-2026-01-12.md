# Rapport d'Audit QA - Carbex

**Date**: 2026-01-12
**Version testee**: MVP v1.0
**Auditeur**: Claude AI
**Branche**: `001-carbex-mvp-platform`
...
Cet audit QA a pour objectif de verifier l'ensemble des fonctionnalites du site Carbex, une plateforme SaaS de bilan carbone pour PME europeennes. L'audit couvre:
...
**Description**:
La variable `APP_NAME` dans le fichier `.env` est configuree a "Laravel" au lieu de "Carbex". Cela affecte le titre des pages d'authentification qui affichent "Laravel" au lieu de "Carbex".
...
1. **Corriger APP_NAME**: Changer `.env` de "Laravel" a "Carbex"
...
Le site Carbex presente des fonctionnalites metier solides (dashboard, emissions, rapports, CSRD) avec 71 tests E2E passants. Cependant, plusieurs problemes critiques empechent une mise en production:
...
- `.env`
- `specs/001-carbex-mvp-platform/spec.md`
- `specs/001-carbex-mvp-platform/plan.md`
