...
return [
    ...
    */
    ...
    'auth' => [
        ...
        'login_subtitle' => 'Gerez votre empreinte carbone',
        ...
        'forgot_password_subtitle' => 'Entrez votre adresse e-mail et nous vous enverrons un lien de reinitialisation.',
        'no_account' => 'Pas encore de compte ?',
        'register_link' => 'Creer un compte',
        'register_title' => 'Creer votre compte',
        ...
        'reset_password_title' => 'Reinitialiser votre mot de passe',
        'reset_password_subtitle' => 'Entrez votre nouveau mot de passe ci-dessous.',
        'reset_password_button' => 'Reinitialiser',
        'send_reset_link' => 'Envoyer le lien',
        'reset_link_sent' => 'Nous vous avons envoye un lien de reinitialisation. Verifiez votre boite mail.',
        ...
        'select_sector' => 'Selectionnez un secteur',
        ...
        // Invitation
        'accept_invitation_title' => 'Rejoignez votre equipe',
        'accept_invitation_subtitle' => 'Vous avez ete invite a rejoindre en tant que :email',
        'accept_invitation_button' => 'Accepter l\'invitation',
    ...
    */
    ...
    'emissions' => [
        ...
        'categories' => [
            ...
            '1_1' => 'Sources fixes de combustion',
            '1_2' => 'Sources mobiles de combustion',
            '1_4' => 'Émissions fugitives',
            '1_5' => 'Émissions de procédés',
            '2_1' => 'Consommation d\'électricité',
            '3_1' => 'Achats de biens et services',
            '3_2' => 'Biens d\'équipement',
            '3_3' => 'Carburant et énergie (hors Scope 1 & 2)',
            '3_5' => 'Déplacements professionnels',
            '4_1' => 'Transport amont de marchandises',
            '4_2' => 'Déchets générés',
            '4_3' => 'Déplacements domicile-travail',
            '4_4' => 'Actifs loués en amont',
            '4_5' => 'Autres émissions indirectes',
        ...
        'factors' => [
            ...
            'semantic_placeholder' => 'Décrivez ce que vous cherchez en langage naturel...',
            'semantic_search' => 'Recherche intelligente',
            'toggle_semantic' => 'Activer/désactiver la recherche intelligente',
            'mode_semantic' => 'Mode IA',
    ...
    */
    ...
    'ai' => [
        ...
        'add_to_plan' => 'Ajouter au plan de transition',
        'view_details' => 'Voir les détails',
        'recommendation_details' => 'Détails de la recommandation',
        'detail' => [
            'description' => 'Description',
            'impact' => 'Impact',
            ...
            'timeline' => 'Délai',
            'affected_scopes' => 'Scopes concernés',
        ],
    ...
    */
    ...
    'settings' => [
        ...
        'ai' => [
            ...
            'status' => 'Statut IA',
            'status_desc' => 'Aperçu des fournisseurs IA configurés',
            'connected' => 'Connecté',
            'not_connected' => 'Non connecté',
            'configured' => 'Configuré',
            'not_configured_status' => 'Non configuré',
            'api_keys' => 'Clés API',
            'api_keys_desc' => 'Configurez vos clés API des fournisseurs IA. Les clés sont chiffrées et stockées de manière sécurisée.',
            'anthropic_desc' => 'Modèles Claude - Idéal pour l\'analyse carbone',
            'openai_desc' => 'Modèles GPT - IA polyvalente',
            'google_desc' => 'Modèles Gemini - IA Google',
            'deepseek_desc' => 'Modèles DeepSeek - IA économique',
            'model' => 'Modèle',
            'test' => 'Tester',
            'general' => 'Paramètres généraux',
            'general_desc' => 'Configurez le comportement par défaut de l\'IA',
            'default_provider' => 'Fournisseur par défaut',
            'default_provider_desc' => 'Fournisseur utilisé quand aucun n\'est spécifié',
            'max_tokens' => 'Tokens maximum',
            'max_tokens_desc' => 'Nombre maximum de tokens dans les réponses IA (256-32000)',
            'temperature' => 'Température',
            'temperature_desc' => 'Niveau de créativité (0 = déterministe, 2 = créatif)',
            'features' => 'Fonctionnalités IA',
            'features_desc' => 'Activer ou désactiver les fonctionnalités IA dans l\'application',
            'features_for_plan' => 'Fonctionnalités IA disponibles selon votre abonnement',
            'chat_widget' => 'Widget de chat IA',
            'chat_widget_desc' => 'Afficher le widget d\'assistant IA en bas à droite',
            'emission_helper' => 'Assistant de saisie',
            'emission_helper_desc' => 'Assistance IA lors de la saisie des émissions',
            'document_extraction' => 'Extraction de documents',
            'document_extraction_desc' => 'Extraire les données d\'émission des documents téléversés (factures, rapports)',
            'saved' => 'Paramètres IA enregistrés avec succès',
            'key_saved' => 'Clé API :provider enregistrée avec succès',
            'key_removed' => 'Clé API :provider supprimée',
            'invalid_key' => 'Veuillez entrer une clé API valide',
            'not_configured' => ':provider n\'est pas configuré. Ajoutez d\'abord une clé API.',
            'connection_success' => 'Connexion :provider réussie !',
            'connection_failed' => 'Connexion :provider échouée. Vérifiez votre clé API.',
            'connection_error' => 'Erreur de connexion : :error',
            'help_title' => 'Obtenir des clés API',
            'get_anthropic_key' => 'Obtenir votre clé API Anthropic',
            'get_openai_key' => 'Obtenir votre clé API OpenAI',
            'get_google_key' => 'Obtenir votre clé API Google AI',
            'get_deepseek_key' => 'Obtenir votre clé API DeepSeek',
            // New usage-based translations
            'usage_title' => 'Utilisation IA',
            'usage_desc' => 'Suivi de votre consommation IA ce mois-ci',
            'tokens_used' => 'Tokens utilisés',
            'requests_month' => 'Requêtes ce mois',
            'estimated_cost' => 'Coût estimé',
            'of_limit' => 'sur :limit',
            'of_requests' => 'sur :limit requêtes',
            'unlimited' => 'Illimité',
            'included_in_plan' => 'Inclus dans votre abonnement',
            'available_providers' => 'Fournisseurs IA disponibles',
            'providers_configured_by_admin' => 'Les fournisseurs IA sont configurés par l\'administrateur',
            'default' => 'Par défaut',
            'no_providers' => 'Aucun fournisseur IA configuré',
            'contact_admin' => 'Contactez votre administrateur pour activer les fonctionnalités IA',
    ...
    */
    ...
    'admin' => [
        ...
        'users' => [
            ...
            'organization_role' => 'Organisation & Rôle',
        ...
        'sites' => [
            ...
            'energy_rating' => 'Classe énergie',
            'energy' => 'Énergie',
            'electricity_provider' => 'Fournisseur électricité',
            'renewable_energy' => 'Énergie renouvelable',
            'renewable_percentage' => '% renouvelable',
            'annual_energy' => 'Énergie annuelle',
            'heating_type' => 'Type de chauffage',
            'heating_types' => [
                'gas' => 'Gaz',
                'oil' => 'Fioul',
            ...
            'cooling_type' => 'Type de climatisation',
            'cooling_types' => [
                'ac' => 'Climatisation',
                'heat_pump' => 'Pompe à chaleur',
                'passive' => 'Rafraîchissement passif',
                'none' => 'Aucun',
            ],
            'status' => 'Statut',
            'is_primary' => 'Site principal',
        ...
        'subscriptions' => [
            ...
            'stripe' => 'Informations Stripe',
            'stripe_subscription_id' => 'ID Abonnement',
            'stripe_customer_id' => 'ID Client',
            'stripe_price_id' => 'ID Prix',
            ...
            'cancel_at_period_end' => 'Annulation en fin de période',
            'canceling' => 'En cours d\'annulation',
            'limits' => 'Limites d\'utilisation',
            'bank_connections_limit' => 'Limite connexions bancaires',
            'bank_connections_used' => 'Connexions bancaires utilisées',
            'users_limit' => 'Limite utilisateurs',
            'users_used' => 'Utilisateurs utilisés',
            'users' => 'Utilisateurs',
            'sites_limit' => 'Limite sites',
            'sites_used' => 'Sites utilisés',
            'sites' => 'Sites',
            'reports_limit' => 'Limite rapports mensuels',
            'reports_used' => 'Rapports mensuels utilisés',
            'features_section' => 'Fonctionnalités',
            ...
            'feature_options' => [
                ...
                'api' => 'Accès API',
                'supplier' => 'Portail fournisseurs',
                'csrd' => 'Conformité CSRD',
        ...
        'transactions' => [
            ...
            'description' => 'Description',
            'clean_description' => 'Description nettoyée',
            'counterparty_name' => 'Nom contrepartie',
            'counterparty' => 'Contrepartie',
            'counterparty_iban' => 'IBAN contrepartie',
            'mcc_code' => 'Code MCC',
            ...
            'user_category' => 'Catégorie utilisateur',
            'flags' => 'Indicateurs',
            'is_excluded' => 'Exclu',
            'excluded' => 'Exclu',
            'exclusion_reason' => 'Motif d\'exclusion',
