...
return [
    ...
    */
    ...
    'sites' => [
        ...
        // Building types
        'building_types' => [
            'office_modern' => 'Bureau moderne',
            'office_traditional' => 'Bureau traditionnel',
            'warehouse_heated' => 'Entrepôt chauffé',
            'warehouse_unheated' => 'Entrepôt non chauffé',
            'retail_standalone' => 'Commerce indépendant',
            'retail_mall' => 'Commerce en centre commercial',
            'factory_light' => 'Usine légère',
            'factory_heavy' => 'Usine lourde',
        ...
        'import' => [
            ...
            'rows' => 'lignes',
            'confirm' => 'Importer',
            'success' => ':count site(s) importé(s) avec succès.',
            ...
            'duplicate' => 'Le site ":name" existe déjà.',
        ],
        ...
        'comparison' => [
            ...
            'total_emissions_t' => 'Émissions totales (t)',
            'avg_per_m2' => 'Moy. kg CO2e/m²',
            'avg_per_employee' => 'Moy. t/employé',
            'emissions_by_site' => 'Émissions par site',
            'detailed_breakdown' => 'Détail par site',
            'total_t' => 'Total (t)',
            'rating' => 'Note',
            'sort_by_emissions' => 'Par émissions',
            'sort_by_m2' => 'Par m²',
            'sort_by_employee' => 'Par employé',
            'sort_by_name' => 'Par nom',
            'no_sites' => 'Aucun site configuré',
            'no_sites_desc' => 'Ajoutez des sites pour voir la comparaison de leurs émissions.',
            'highest_emitter' => 'Site le plus émetteur',
            'highest_emitter_msg' => ':site est votre site le plus émetteur avec :emissions t CO2e.',
            'efficiency_opportunity' => 'Opportunité d\'amélioration',
            'efficiency_opportunity_msg' => ':site a une note d\'efficacité :rating. Envisagez des actions de réduction.',
            'best_performer' => 'Meilleur site',
            'best_performer_msg' => ':site est votre site le plus efficace avec une note :rating.',
        ],
    ],
