...
return [
    ...
    */
    ...
    'organization' => [
        ...
        'display_settings_desc' => 'Passen Sie Ihre Arbeitsbereichsoberfläche an',
        'navigation_mode' => 'Navigationsmodus',
        'navigation_scopes_desc' => 'Klassische Navigation nach GHG-Scopes (1, 2, 3)',
        'navigation_pillars_desc' => '5-Säulen-Navigation: Messen, Planen, Engagieren, Berichten, Fördern',
    ...
    */
    ...
    'sites' => [
        ...
        // Building types
        'building_types' => [
            'office_modern' => 'Modernes Büro',
            'office_traditional' => 'Traditionelles Büro',
            'warehouse_heated' => 'Beheiztes Lager',
            'warehouse_unheated' => 'Unbeheiztes Lager',
            'retail_standalone' => 'Einzelhandel freistehend',
            'retail_mall' => 'Einkaufszentrum',
            'factory_light' => 'Leichte Fabrik',
            'factory_heavy' => 'Schwere Fabrik',
        ...
        'import' => [
            ...
            'rows' => 'Zeilen',
            'confirm' => 'Importieren',
            'success' => ':count Standort(e) erfolgreich importiert.',
            'errors' => 'Importfehler',
            'file_read_error' => 'Datei konnte nicht gelesen werden.',
            'empty_file' => 'Die Datei ist leer.',
            'missing_columns' => 'Fehlende Spalten: :columns',
            'no_valid_rows' => 'Keine gültigen Zeilen gefunden.',
            'duplicate' => 'Standort ":name" existiert bereits.',
        ],

        // Site comparison
        'comparison' => [
            'title' => 'Standortvergleich',
            'subtitle' => 'Analysieren und vergleichen Sie die CO2-Emissionen Ihrer Standorte',
            'total_sites' => 'Aktive Standorte',
            'total_emissions_t' => 'Gesamtemissionen (t)',
            'avg_per_m2' => 'Durchschn. kg CO2e/m²',
            'avg_per_employee' => 'Durchschn. t/Mitarbeiter',
            'emissions_by_site' => 'Emissionen nach Standort',
            'detailed_breakdown' => 'Standortaufschlüsselung',
            'total_t' => 'Gesamt (t)',
            'rating' => 'Bewertung',
            'sort_by_emissions' => 'Nach Emissionen',
            'sort_by_m2' => 'Nach m²',
            'sort_by_employee' => 'Nach Mitarbeiter',
            'sort_by_name' => 'Nach Name',
            'no_sites' => 'Keine Standorte konfiguriert',
            'no_sites_desc' => 'Fügen Sie Standorte hinzu, um deren Emissionsvergleich zu sehen.',
            'highest_emitter' => 'Standort mit höchsten Emissionen',
            'highest_emitter_msg' => ':site ist Ihr Standort mit den höchsten Emissionen von :emissions t CO2e.',
            'efficiency_opportunity' => 'Verbesserungsmöglichkeit',
            'efficiency_opportunity_msg' => ':site hat eine Effizienzklasse von :rating. Erwägen Sie Reduktionsmaßnahmen.',
            'best_performer' => 'Bester Standort',
            'best_performer_msg' => ':site ist Ihr effizientester Standort mit Klasse :rating.',
        ],
    ],
    ...
    */
    ...
    'pillars' => [
        'measure' => [
            ...
            'scope2' => 'Scope 2 - Indirekte Energie',
            'scope3' => 'Scope 3 - Andere indirekte',
            'documents' => 'Dokumente & Rechnungen',
            'analysis' => 'Datenanalyse',
        ],
        'plan' => [
            'name' => 'Planen',
            'objectives' => 'Ziele & Trajektorie',
            'actions' => 'Aktionsplan',
        ...
        'engage' => [
            ...
            'employees' => 'Teams & Mitarbeiter',
            'sites' => 'Standorte & Einrichtungen',
        ],
        'report' => [
            'name' => 'Berichten',
            'reports' => 'Berichte & Exporte',
            'compliance' => 'Regulatorische Compliance',
            'history' => 'Bilanzhistorie',
        ],
        'promote' => [
            'name' => 'Fördern',
            'badges' => 'Abzeichen & Belohnungen',
            'showcase' => 'Nachhaltigkeits-Schaufenster',
            'share' => 'Engagements teilen',
        ],
    ],
